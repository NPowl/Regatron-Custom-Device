...
<Library LVVersion="20008000">
	...
	<Item Name="Engine" Type="Folder">
		<Item Name="Init" Type="Folder">
			<Item Name="Connect to IP Address.vi" Type="VI" URL="../Init/Connect to IP Address.vi"/>
			<Item Name="Find FIFO Indexes.vi" Type="VI" URL="../Init/Find FIFO Indexes.vi"/>
			<Item Name="Get Input Array.vi" Type="VI" URL="../Init/Get Input Array.vi"/>
			<Item Name="Get Output Array.vi" Type="VI" URL="../Init/Get Output Array.vi"/>
		</Item>
